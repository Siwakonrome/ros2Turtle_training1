...
#include "turtlesim_interfaces/srv/detail/set_goal__rosidl_typesupport_fastrtps_c.h"
...
using _SetGoal_Request__ros_msg_type = turtlesim_interfaces__srv__SetGoal_Request;
...
size_t get_serialized_size_turtlesim_interfaces__srv__SetGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetGoal_Request__ros_msg_type * ros_message = static_cast<const _SetGoal_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetGoal_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtlesim_interfaces__srv__SetGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_interfaces
size_t max_serialized_size_turtlesim_interfaces__srv__SetGoal_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_turtlesim_interfaces__srv__SetGoal_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_interfaces, srv, SetGoal_Request)() {
...
using _SetGoal_Response__ros_msg_type = turtlesim_interfaces__srv__SetGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_interfaces
size_t get_serialized_size_turtlesim_interfaces__srv__SetGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetGoal_Response__ros_msg_type * ros_message = static_cast<const _SetGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_turtlesim_interfaces__srv__SetGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim_interfaces
size_t max_serialized_size_turtlesim_interfaces__srv__SetGoal_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_turtlesim_interfaces__srv__SetGoal_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_interfaces, srv, SetGoal_Response)() {
...
// already included above
// #include "turtlesim_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "turtlesim_interfaces/srv/set_goal.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_interfaces, srv, SetGoal)() {
