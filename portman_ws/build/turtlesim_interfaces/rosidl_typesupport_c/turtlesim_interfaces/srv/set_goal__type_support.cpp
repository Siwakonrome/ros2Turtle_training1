...
static const _SetGoal_Request_type_support_symbol_names_t _SetGoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_interfaces, srv, SetGoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim_interfaces, srv, SetGoal_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlesim_interfaces, srv, SetGoal_Request)() {
  return &::turtlesim_interfaces::srv::rosidl_typesupport_c::SetGoal_Request_message_type_support_handle;
}
...
static const _SetGoal_Response_type_support_symbol_names_t _SetGoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_interfaces, srv, SetGoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim_interfaces, srv, SetGoal_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_turtlesim_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlesim_interfaces, srv, SetGoal_Response)() {
  return &::turtlesim_interfaces::srv::rosidl_typesupport_c::SetGoal_Response_message_type_support_handle;
}
...
static const _SetGoal_type_support_symbol_names_t _SetGoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_interfaces, srv, SetGoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim_interfaces, srv, SetGoal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, turtlesim_interfaces, srv, SetGoal)() {
  return &::turtlesim_interfaces::srv::rosidl_typesupport_c::SetGoal_service_type_support_handle;
}
