...
#include "turtlesim_interfaces/srv/detail/set_goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtlesim_interfaces::srv::SetGoal_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim_interfaces::srv::SetGoal_Request & ros_message)
{
  // Member: position
...
{
  auto typed_message =
    static_cast<const turtlesim_interfaces::srv::SetGoal_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlesim_interfaces::srv::SetGoal_Request *>(
    untyped_ros_message);
...
{
  return &turtlesim_interfaces::srv::typesupport_fastrtps_cpp::_SetGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_interfaces, srv, SetGoal_Request)() {
  return &turtlesim_interfaces::srv::typesupport_fastrtps_cpp::_SetGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim_interfaces
cdr_serialize(
  const turtlesim_interfaces::srv::SetGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim_interfaces::srv::SetGoal_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const turtlesim_interfaces::srv::SetGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtlesim_interfaces::srv::SetGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtlesim_interfaces::srv::typesupport_fastrtps_cpp::_SetGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_interfaces, srv, SetGoal_Response)() {
  return &turtlesim_interfaces::srv::typesupport_fastrtps_cpp::_SetGoal_Response__handle;
}
...
{
  return &turtlesim_interfaces::srv::typesupport_fastrtps_cpp::_SetGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_interfaces, srv, SetGoal)() {
  return &turtlesim_interfaces::srv::typesupport_fastrtps_cpp::_SetGoal__handle;
}
