...
static const _RandGoal_Request_type_support_symbol_names_t _RandGoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_interfaces, srv, RandGoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim_interfaces, srv, RandGoal_Request)),
  }
};
...
{
  return &::turtlesim_interfaces::srv::rosidl_typesupport_cpp::RandGoal_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim_interfaces, srv, RandGoal_Request)() {
  return get_message_type_support_handle<turtlesim_interfaces::srv::RandGoal_Request>();
}
...
static const _RandGoal_Response_type_support_symbol_names_t _RandGoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_interfaces, srv, RandGoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim_interfaces, srv, RandGoal_Response)),
  }
};
...
{
  return &::turtlesim_interfaces::srv::rosidl_typesupport_cpp::RandGoal_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim_interfaces, srv, RandGoal_Response)() {
  return get_message_type_support_handle<turtlesim_interfaces::srv::RandGoal_Response>();
}
...
static const _RandGoal_type_support_symbol_names_t _RandGoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_interfaces, srv, RandGoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim_interfaces, srv, RandGoal)),
  }
};
...
{
  return &::turtlesim_interfaces::srv::rosidl_typesupport_cpp::RandGoal_service_type_support_handle;
}
