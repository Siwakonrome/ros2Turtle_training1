...
class Metaclass_SetGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtlesim_interfaces.srv.SetGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtlesim_interfaces.srv import _set_goal
...
class SetGoal(metaclass=Metaclass_SetGoal):
    from turtlesim_interfaces.srv._set_goal import SetGoal_Request as Request
    from turtlesim_interfaces.srv._set_goal import SetGoal_Response as Response
